def englishNumber(number)
  ...
  remaining = remaining - millions*1_000_000

  if millions > 0
    millions = englishNumber(millions)
...
RSpec.describe 'englishNumber' do
  ...
  it 'returns "one million thirty" for 1,000,030' do
    expect(englishNumber(1_000_030)).to eq("one million thirty")
  end
end

#puts englishNumber(1230040)
